...
public class LoteGuia extends Valueable {
	...
	public static class GuiaTISS extends Valueable {
		...
		public void setProcedimentos(List<Procedimento> nodes) {
			System.err.println("GuiaTISS -> setProcedimentos: " + nodes);
		}

		public void addProcedimento(Procedimento node) {
			System.err.println("GuiaTISS -> addProcedimento: " + node);
		}
